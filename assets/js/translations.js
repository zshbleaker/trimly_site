window.T = {
            ...
            items: [
                {
                    ...
                    desc: 'You keep the camera rolling all day and end up with one long unedited file. '
                        + 'Trimly pulls out arrival, meals, and the night skyline as separate clips, '
                        + 'exported to Photos in order.',
                },
                {
                    id: 'party',
        ...
        features: [{
            ...
            },
            {
                ...
                points: [
                    ...
                    'GPS, device, and lens metadata preserved in photo details',
                ],
            },
            {
                eyebrow: 'Capture',
            ...
            },
            {
                ...
                points: [
                    ...
                    'Cut silence in interviews, podcasts, and meeting recordings',
                ],
            },
            {
                eyebrow: 'Speed',
    ...
    zh: {
            ...
            items: [
                {
                    id: 'travel',
                    title: '旅行随拍',
                    desc: '出游时相机一直开着，落地、吃饭、看夜景全录进一条长片里。'
                        + 'Trimly 拆出几个独立片段，按真实时间顺序导出到相册。',
                },
                {
                    id: 'party',
                    title: '生日派对与聚会',
        ...
        features: [{
            ...
            },
            {
                eyebrow: '跨设备',
                title: '换台设备，进度不丢',
                desc: '路上用 iPhone 粗剪到一半？回到家打开 Mac，进度立刻接上。iCloud 只同步剪辑记录与 LUT，视频文件始终留在设备本地。旅行归来，AirPlay 投屏到客厅电视，和家人朋友坐在沙发上一块剪、一块选。',
                points: [
                    'iCloud 同步剪辑记录与 LUT（视频文件留在设备本地）',
                    'Handoff 换设备即继续',
                    'AirPlay 一键投屏至电视',
                ],
            },
        ...
        legal: {
            ...
            intro: 'Trimly 在设备本地处理你的媒体，素材始终保留在 iPhone、iPad 或 Mac 上。剪辑记录与 LUT 可通过 iCloud 在你的 Apple 设备间同步，视频文件本身绝不会上传。本政策用直白的语言说明这对你的隐私意味着什么。',
            ...
            sections: [
                ...
                {
                    h: '文件与照片访问',
                    p: '当你从「文件」App、外接硬盘或照片图库打开媒体时，Trimly 仅读取它，以便你裁剪和导出。所有处理都在你的设备本地完成，导出的片段会保存到你选择的位置。Trimly 仅在获得你的授权后访问照片图库，且只用于导入或保存你所选择的媒体。',
                },
                {
                    h: '无账号、无第三方',
                ...
                {
                    h: '儿童隐私',
                    p: '由于 Trimly 完全不收集任何数据，因此不会有意收集包括儿童在内的任何人的信息。',
                },
                {
                    h: '政策变更',
    ...
    ja: {
            ...
            items: [
                {
                    id: 'travel',
                    title: '旅行の連続撮影',
                    desc: '旅先でカメラを止めずに撮り続け、到着・食事・夜景が1本の未編集ロングに。'
                        + 'Trimlyなら個別クリップに切り出し、実際の順番のまま写真ライブラリへ。',
                },
                {
                    id: 'party',
                    title: '誕生日・家族の集まり',
        ...
        bottomCta: {
            heading: '次のクリップまで、数秒。',
            subtitle: '一度の購入で iPhone、iPad、Mac すべてに。',
        },
        footer: {
            home: 'ホーム',
            support: 'サポート',
            ...
            items: [
                {
                    id: 'travel',
                    title: '여행 연속 촬영',
                    desc: '여행 중 카메라를 계속 켜 두면 도착, 식사, 야경이 하나의 긴 영상에 담깁니다. '
                        + 'Trimly로 각각 클립으로 나눠 실제 순서대로 사진 보관함에보낼 수 있습니다.',
                },
                {
                    id: 'party',
                    title: '생일 파티·가족 모임',
            ...
            items: [
                {
                    ...
                    desc: 'Dejas la cámara grabando todo el día y acabas con un solo archivo largo sin editar. '
                        + 'Trimly extrae la llegada, la comida y el paisaje nocturno como clips separados, '
                        + 'exportados a Fotos en orden.',
                },
                {
                    id: 'party',
        ...
        features: [{
            ...
            },
            {
                ...
                points: [
                    ...
                    'GPS, dispositivo y lente conservados en los detalles',
                ],
            },
            {
                eyebrow: 'Captura',
            ...
            },
            {
                ...
                points: [
                    ...
                    'Corta silencios en entrevistas, pódcasts y reuniones',
                ],
            },
            {
                eyebrow: 'Velocidad',
    ...
    ar: {
            ...
            items: [
                {
                    id: 'travel',
                    title: 'تصوير السفر',
                    desc: 'تُبقي الكاميرا تعمل طوال اليوم في الرحلة، فتنتهي بملف طويل واحد. '
                        + 'Trimly يستخرج الوصول والوجبة والمشهد الليلي كمقاطع منفصلة، '
                        + 'مُصدَّرة إلى الصور بالترتيب.',
                },
                {
                    id: 'party',
        ...
        features: [{
            ...
            },
            {
                ...
                points: [
                    ...
                    'GPS والجهاز والعدسة محفوظة في التفاصيل',
                ],
            },
            {
                eyebrow: 'التقاط',
            ...
            },
            {
                ...
                points: [
                    ...
                    'قص الصمت في المقابلات والبودكاستs والاجتماعات',
                ],
            },
            {
                eyebrow: 'السرعة',
            ...
            },
            {
                ...
                points: [
                    ...
                    'نوافذ قابلة للتغيير مع تخطيط متكيّف',
                ],
            },
            {
                eyebrow: 'عربي أصيل',
                title: 'دعم كامل لاتجاه اليمين إلى اليسار.',
                desc: 'كل عنصر في Trimly، من القوائم والجدول الزمني وقائمة المقاطع إلى أدوات التحكم وتدفق التصدير، يتبع اتجاه اليمين إلى اليسار بصورة أصيلة.',
                points: [
                    'واجهة مستخدم كاملة من اليمين إلى اليسار',
        ...
        bottomCta: {
            heading: 'مقطعك التالي على بُعد ثوانٍ.',
            subtitle: 'دفعة واحدة. iPhone وiPad وMac.',
        },
        footer: {
            home: 'الرئيسية',
            support: 'الدعم',
